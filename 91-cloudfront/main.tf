...
resource "aws_route53_record" "cdn" {
  zone_id         = var.zone_id
  name            = "${var.environment}.${var.domain_name}" # dev.anuarjun.space
  type            = "A"
  allow_overwrite = true

  alias {
    # This references CloudFront distribution
